...
export const RUNE_FAMILIES = [
  { name: 'Warrior', stat: 'Physical ATK', values: ['+10', '+15', '+25', '+35', '+50'], slots: ['Headgear', 'Accessory'], rune: 'Rune of Might' },
  { name: 'Sorcery', stat: 'Magic ATK', values: ['+10', '+15', '+25', '+35', '+50'], slots: ['Headgear', 'Accessory'], rune: 'Rune of Sorcery' },
  { name: 'Haste', stat: 'ASPD', values: ['+1%', '+2%', '+3%', '+4%', '+5%'], slots: ['Garment', 'Footgear'], rune: 'Any rune' },
  { name: 'Sniper', stat: 'Critical', values: ['+3', '+5', '+8', '+12', '+16'], slots: ['Accessory'], rune: 'Rune of Precision' },
  { name: 'Phantom', stat: 'Flee', values: ['+4', '+6', '+9', '+13', '+18'], slots: ['Armor', 'Garment', 'Footgear'], rune: 'Any rune' },
  { name: 'Guardian', stat: 'Max HP', values: ['+2%', '+3%', '+4%', '+6%', '+8%'], slots: ['Armor', 'Garment', 'Footgear'], rune: 'Any rune' },
  { name: 'Cleric', stat: 'Healing power', values: ['+2%', '+4%', '+6%', '+9%', '+12%'], slots: ['Headgear', 'Armor'], rune: 'Any rune' },
  { name: 'Flow', stat: 'After-cast delay', values: ['-3%', '-6%', '-10%', '-15%', '-20%'], slots: ['Headgear', 'Armor'], rune: 'Rune of Alacrity' },
  { name: 'Focus', stat: 'Variable cast time', values: ['-3%', '-6%', '-9%', '-12%', '-15%'], slots: ['Headgear', 'Accessory'], rune: 'Rune of Focus' },
];
...
function familyCard(family) {
  return `<article class="rune-family" data-rune-family data-slots="${family.slots.join(' ')}"><p class="eyebrow">${escapeHtml(family.stat)}</p><h2>${escapeHtml(family.name)} Stone</h2><p><strong>Fits:</strong> ${family.slots.map(escapeHtml).join(' · ')}</p><div class="rune-levels">${family.values.map((value, index) => `<span><small>Lv.${index + 1}</small><strong>${escapeHtml(value)}</strong></span>`).join('')}</div><p class="muted-copy"><strong>Rune fuel:</strong> ${escapeHtml(fuelLabel(family))}</p></article>`;
}
